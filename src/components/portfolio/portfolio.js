        ...
        <section id="portfolio">
          ...
          <section id="projects" />
            <div>
              ...
              <a href="https://github.com/401-final-project/front-end" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
              <a href="https://play.google.com/store/apps/details?id=com.jaredpattison.BUZZCARD&hl=en_US" target="_blank" rel="noopener noreferrer">Install BUZZCARD!</a>
            </div>
            <div>
              <h4>atnote</h4>
              ...
              <a href="https://github.com/AtNote/AtNote" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
              <a href="https://www.npmjs.com/package/atnote" target="_blank" rel="noopener noreferrer">Try atnote!</a>
            </div>
            <div>
              <h4>Space Rover</h4>
              ...
              <a href="https://github.com/hcherewaty/space_rover" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
              <a href="http://www.spacerover.tech/" target="_blank" rel="noopener noreferrer">Check out Space Rover!</a>
            </div>
            <div>
              ...
              <a href="https://github.com/niesssiobhan/packing-planner" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
              <a href="https://niesssiobhan.github.io/packing-planner/" target="_blank" rel="noopener noreferrer">Start Packing!</a>
            </div>
        </section>
      </>
    );
